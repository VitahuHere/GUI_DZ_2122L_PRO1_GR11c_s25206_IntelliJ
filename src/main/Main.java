...
public class Main {
    public static void main(String[] args){
        ...
        Port.ships.get(0).loadContainer(new StandardContainer(12, 12, 12, list, list));
        Port.ships.get(0).loadContainer(new StandardContainer(12, 12, 12, list, list));
        Port.ships.get(0).loadContainer(new StandardContainer(12, 12, 12, list, list));
        Port.ships.get(0).loadContainer(new ToxicLiquidContainer(12, 12, 12, list, list, 12, "idk", true));
        Port.ships.get(0).loadContainer(new ToxicLiquidContainer(12, 12, 12, list, list, 12, "idk", true));
        Port.ships.get(0).loadContainer(new ToxicLiquidContainer(12, 12, 12, list, list, 12, "idk", true));
        Port.ships.get(0).loadContainer(new ToxicLiquidContainer(12, 12, 12, list, list, 12, "idk", true));
        Port.ships.get(0).loadContainer(new ToxicLiquidContainer(12, 12, 12, list, list, 12, "idk", true));
